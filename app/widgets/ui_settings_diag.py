...
################################################################################
## Form generated from reading UI file 'settings_diagJfvTJS.ui'
##
...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.gridLayout_2.addWidget(self.sb_print_autom_timer, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.cb_select_printer, 4, 1, 1, 1)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.label_2.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p><span style=\" font-weight:600;\">Serial number management</span></p></body></html>", None))
        self.cb_sn_active.setText(QCoreApplication.translate("SettingsDialog", u"Serial numbers management active", None))
        ...
        self.label_9.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p>Padding bottom <span style=\" font-style:italic;\">(default=8)</span></p></body></html>", None))
        self.label_10.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p>Padding left <span style=\" font-style:italic;\">(default=10)</span></p></body></html>", None))
        self.label_8.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p>Padding top <span style=\" font-style:italic;\">(default=8)</span></p></body></html>", None))
        self.label_5.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p>Columns paper<span style=\" font-style:italic;\"> (default=2)</span></p></body></html>", None))
        ...
        self.label_7.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p>Column height <span style=\" font-style:italic;\">(default=30)</span></p></body></html>", None))
        self.label_11.setText(QCoreApplication.translate("SettingsDialog", u"<html><head/><body><p>Padding right <span style=\" font-style:italic;\">(default=10)</span></p></body></html>", None))
        ...
        self.label_3.setText(QCoreApplication.translate("SettingsDialog", u"Print automatically time", None))
#if QT_CONFIG(tooltip)
